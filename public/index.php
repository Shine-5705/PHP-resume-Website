...
$app->get('/publications', function ($request, $response, $args) {
    ...
    $publications = require __DIR__ . '/data/publications.php';

    $seo = [
        'title' => 'Publications - Shine Gupta',
        'description' => 'Peer-reviewed and workshop papers by Shine Gupta, including work at ICML 2026 SCALE Workshop and NeurIPS 2026 GlobalSouthAI Workshop.',
        'keywords' => 'Publications, Research Papers, ICML, NeurIPS, LLM Agents, AI Research',
        'author' => 'Shine Gupta',
        'url' => 'https://shine-5705.github.io/publications',
        'image' => 'https://shine-5705.github.io/assets/images/profile.webp',
        'type' => 'website',
        'locale' => 'en_US',
        'site_name' => 'Shine Gupta\'s Resume'
    ...
    return $view->render($response, 'publications.twig', [
        'seo' => $seo,
...
$app->get('/projects', function ($request, $response, $args) {
    ...
    $sideProjects = require __DIR__ . '/data/projects.php';

    $seo = [
        'title' => 'Projects - Shine Gupta',
        'description' => 'Side projects by Shine Gupta spanning AI agents, LLM fine-tuning, healthcare, automation, and computer vision.',
        'keywords' => 'Projects, AI Agents, LLMs, Machine Learning, Side Projects',
        'author' => 'Shine Gupta',
        'url' => 'https://shine-5705.github.io/projects',
        'image' => 'https://shine-5705.github.io/assets/images/profile.webp',
        'type' => 'website',
        'locale' => 'en_US',
        'site_name' => 'Shine Gupta\'s Resume'
    ...
    return $view->render($response, 'projects.twig', [
        'seo' => $seo,
